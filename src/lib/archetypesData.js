export const ARCHETYPE_CATEGORIES = [
  { id: 'all', label: 'All 21 Archetypes', emoji: '✨' },
  { id: 'endurance', label: 'Endurance & Depth', emoji: '🏔️' },
  { id: 'emotion', label: 'Emotion & Heart', emoji: '💖' },
  { id: 'aesthetic', label: 'Art & Aesthetic', emoji: '🎨' },
  { id: 'night_owl', label: 'Night Owls & Chaos', emoji: '🌙' },
  { id: 'social', label: 'Community & Voice', emoji: '☕' },
  { id: 'deep_focus', label: 'Deep Lore & Focus', emoji: '🔍' },
  { id: 'speed', label: 'Nomads & Momentum', emoji: '⚡' }
];
...
export const ARCHETYPES = {
  ...
  serial_starter: {
    ...
    category: 'speed',
    color: '#E07A5F',
    image: '/images/archetypes/serial_starter.jpeg',
  ...
  page_artist: {
    ...
    category: 'aesthetic',
    color: '#9B5DE5',
    image: '/images/archetypes/page_artist.jpeg',
  ...
  book_dragon: {
    ...
    category: 'aesthetic',
    color: '#B5179E',
    image: '/images/archetypes/book_dragon.jpeg',
  ...
  comfort_rereader: {
    ...
    category: 'emotion',
    color: '#8D5B4C',
    image: '/images/archetypes/comfort_rereader.jpeg',
  ...
  researcher: {
    ...
    category: 'deep_focus',
    color: '#2B4C7E',
    image: '/images/archetypes/researcher.jpeg',
  ...
  tbr_optimist: {
    ...
    category: 'speed',
    color: '#52796F',
    image: '/images/archetypes/tbr_optimist.jpeg',
  ...
  one_genre_wonder: {
    ...
    category: 'deep_focus',
    color: '#D62828',
    image: '/images/archetypes/one_genre_wonder.jpeg',
  ...
  genre_explorer: {
    id: 'genre_explorer',
    name: 'The Literary Nomad',
    tagline: 'Passport to every literary realm and distant world.',
    emoji: '🌍',
    category: 'deep_focus',
    color: '#2A9D8F',
    image: '/images/archetypes/literary_nomad.jpeg',
    gradient: 'linear-gradient(135deg, #F0FDF4 0%, #DCFCE7 100%)',
    badgeGradient: 'from-[#2A9D8F]/10 to-[#52B788]/10',
    borderStyle: 'border-[#2A9D8F]/20',
    textStyle: 'text-[#2A9D8F]',
  ...
  social_reader: {
    id: 'social_reader',
    name: 'The Chapter Chatter',
    tagline: 'Reading is better when we talk about it.',
    emoji: '☕',
    category: 'social',
    color: '#D97706',
    image: '/images/archetypes/chapter_chatter.jpeg',
  ...
  quote_collector: {
    ...
    category: 'aesthetic',
    color: '#4F46E5',
    image: '/images/archetypes/quote_collector.jpeg',
  ...
  dnf_champion: {
    ...
    category: 'speed',
    color: '#EF4444',
    image: '/images/archetypes/dnf_champion.jpeg',
  ...
  slow_savorer: {
    id: 'slow_savorer',
    name: 'The Bibliosloth',
    tagline: 'One page at a time, delicious and slow.',
    emoji: '🍵',
    category: 'endurance',
    color: '#059669',
    image: '/images/archetypes/bibliosloth.jpeg',
  ...
  book_wreck: {
    id: 'book_wreck',
    name: 'The Plot-Wrecked',
    tagline: 'Currently recovering from fictional trauma.',
    emoji: '💔',
    category: 'emotion',
    color: '#7C3AED',
    image: '/images/archetypes/plot_wrecked.jpeg',
  ...
  cover_lover: {
    ...
    category: 'aesthetic',
    color: '#EC4899',
    image: '/images/archetypes/cover_lover.jpeg',
  ...
  chaos_reader: {
    id: 'chaos_reader',
    name: 'The Literary Gremlin',
    tagline: 'Method to the madness, order in the chaos.',
    emoji: '🎲',
    category: 'night_owl',
    color: '#F59E0B',
    image: '/images/archetypes/literary_gremlin.jpeg',
    gradient: 'linear-gradient(135deg, #FFFBEB 0%, #FEF3C7 100%)',
  ...
  behemoth: {
    ...
    category: 'endurance',
    color: '#1E293B',
    image: '/images/archetypes/behemoth.jpeg',
