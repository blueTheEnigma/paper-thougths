...
export default function DashboardLoading() {
  ...
  return (
    <div className="fixed inset-0 bg-[#FFF5EC] z-50 flex flex-col items-center justify-center p-6 text-center">
      <div className="flex flex-col items-center max-w-md gap-6">
        ...
        <div className="space-y-4">
          <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-ink/40">Unlocking the Archive</h4>
